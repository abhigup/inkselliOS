...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-inksell/DKImagePickerController.framework"
  install_framework "Pods-inksell/KCFloatingActionButton.framework"
  install_framework "Pods-inksell/Material.framework"
